...
public class SingleAntEasyChoices {
  ...
  void run() {
    ...
    com.pseuco.np21.Trail trail = getTrail("Hill", "C995");
  ...
  private void exploreSingleTrail(com.pseuco.np21.Trail trail) {
  ...
  private void returnTrail(com.pseuco.np21.Trail trail) {
